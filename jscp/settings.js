...
let settings = {
    ...
    sequence: 'HAPPY|BIRTHDAY|TO|YOU|INTANN WIJAYANTI|❤',
    sequenceColor: '#ff69b4', // Pink color
    gift: '', // No sticker/GIF
    pages: [
        { image: './image/Birthday!/cover.jpg', content: '' }, // Front cover
        { image: './image/Birthday!/photo1.jpg', content: 'Dear Intann, you bring so much joy and happiness! 💕' },
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        matrixColor1: '#ff69b4', // Pink color
        matrixColor2: '#ff1493', // Pink color
        sequence: 'HAPPY|BIRTHDAY|TO|YOU|INTANN|❤',
        sequenceColor: '#ff69b4', // Pink color
        gift: '', // No sticker/GIF
        enableBook: true,
        enableHeart: true,
